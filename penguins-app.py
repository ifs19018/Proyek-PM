...
Aplikasi ini digunakan untuk memprediksi spesies dari penguin berdasarkan data yang dimasukkan 
""")
...
# Menggabungkan inputan dari user dan dataset yang dimasukkan
